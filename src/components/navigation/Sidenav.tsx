...
const Sidenav = (): JSX.Element => {
  ...
  return (
    <div className="flex-col flex bg-zinc-50 dark:bg-zinc-800 dark:bg-opacity-40 sm:flex-row h-full">
      ...
      <div className="w-full sm:max-w-[5rem] bg-gradient-to-b from-indigo-600 to-indigo-600 flex flex-col items-center gap-6 sm:z-10">
        <div className="px-8 justify-between flex items-center sm:justify-center sm:px-0 h-16 bg-indigo-700 w-full z-10">
          <div className="w-8 h-8 border-indigo-50 border-8 rounded-full"></div>
          {showMenu ? (
            <FiX
        ...
        <div
          ...
          } z-0 transition-[top] duration-300 absolute sm:relative sm:mt-0 sm:py-0 sm:top-0 mt-16 py-4 bg-gradient-to-b from-indigo-600 to-indigo-600  flex flex-col items-center gap-4 w-full px-4`}
        >
          <div className="hover:cursor-pointer bg-opacity-50 flex gap-4 items-center justify-center py-3 rounded-md bg-indigo-700 w-full">
            <FiEdit2 size="1.375rem" className="stroke-indigo-100" />
            <span className="text-white text-lg sm:hidden">Editor</span>
          </div>
          <div className="hover:bg-opacity-50 hover:bg-indigo-700 hover:cursor-pointer  flex gap-4 items-center justify-center py-3 rounded-md w-full">
            <FiEye size="1.375rem" className="stroke-indigo-100" />
            <span className="text-white text-lg sm:hidden">Preview</span>
          </div>
          <div className="hover:bg-opacity-50 hover:bg-indigo-700 hover:cursor-pointer flex gap-4 items-center justify-center py-3 rounded-md w-full">
            <FiDownload size="1.375rem" className="stroke-indigo-100" />
            <span className="text-white text-lg sm:hidden">Download</span>
          </div>
          <div className="hover:bg-opacity-50 hover:bg-indigo-700 hover:cursor-pointer flex gap-4 items-center justify-center py-3 rounded-md w-full">
            <FiXCircle size="1.375rem" className="stroke-indigo-100" />
            <span className="text-white text-lg sm:hidden">Clear</span>
          </div>
          <div
            onClick={handleShowFilesToggle}
            className="lg:hidden hover:bg-opacity-50 hover:bg-indigo-700 hover:cursor-pointer flex gap-4 items-center justify-center py-3 rounded-md w-full"
          >
            <FiFolder size="1.375rem" className="stroke-indigo-100" />
            <span className="text-white text-lg sm:hidden">Files</span>
          </div>
          <div className="bg-indigo-500 h-px w-8"></div>
          <div className="hover:bg-opacity-50 hover:bg-indigo-700 hover:cursor-pointer flex gap-4 items-center justify-center py-3 rounded-md w-full">
            <VscColorMode size="1.375rem" className="fill-indigo-100" />
      ...
      >
        <div className="border-b h-16 flex items-center justify-between px-4 text-lg font-semibold dark:text-zinc-200 dark:border-zinc-600">
          <div>
            Notes{" "}
      ...
      <div className="w-full">
        <div className="bg-white w-full border-b h-16 flex items-center justify-center text-lg font-semibold dark:text-zinc-200 dark:border-zinc-600 dark:bg-zinc-700">
          <div className="flex items-center justify-between w-full max-w-5xl px-8 ">
            <div>Note one</div>
            <FiSave className="dark:stroke-zinc-400 cursor-pointer hover:stroke-indigo-500 dark:hover:stroke-indigo-400" />
          </div>
        </div>

        <div className="h-full w-full max-w-5xl m-auto mt-8 px-8">
          <div className="shadow-lg bg-white h-full p-8 rounded-md dark:bg-zinc-700 dark:border-zinc-600">
