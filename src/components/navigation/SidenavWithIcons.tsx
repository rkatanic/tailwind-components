...
const SidenavWithIcons = (): JSX.Element => (
  <div className="flex flex-col items-center gap-10 py-8 w-20 border-r-2 h-[42rem] dark:border-zinc-800 bg-white dark:bg-black">
    ...
    <div className="flex justify-center relative before:absolute before:w-[2px] before:right-[-2px] before:rounded before:-top-1/2 w-full before:h-24">
      <RiEyeFill
        size="1.25rem"
        className="cursor-pointer hover:fill-cyan-600 dark:hover:fill-cyan-500 fill-zinc-300 dark:fill-zinc-400"
      />
    </div>
    <RiDownloadCloud2Fill
      size="1.25rem"
