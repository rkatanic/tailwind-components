const Button = (): JSX.Element => (
  <div className="flex flex-column gap-8">
    ...
    <button
      type="button"
      className="shadow-sm font-semibold text-sm border border-gray-300 px-4 py-2 rounded-md text-gray-900 bg-white hover:bg-gray-50 dark:shadow-md dark:text-gray-100 dark:hover:bg-gray-700 dark:border-gray-600 dark:bg-gray-800"
    >
      Button
    </button>
  </div>
