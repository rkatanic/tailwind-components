...
const SidenavV2 = (): JSX.Element => (
  <div className="p-4 w-full max-w-xs bg-zinc-100 border-r flex flex-col justify-between gap-8 dark:bg-zinc-800 dark:border-zinc-700">
    <div className="flex flex-col gap-8">
      <div className="flex gap-4 items-center">
        <div className="w-8 h-8 rounded-full border-8 border-emerald-500"></div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="bg-zinc-200 font-semibold text-zinc-600 rounded-md p-2 flex gap-4 items-center hover:bg-zinc-200 cursor-pointer dark:hover:bg-zinc-700 dark:bg-zinc-700 dark:text-zinc-200">
          <FiHome
            size="1.25rem"
        ...
        <p className="flex gap-4 items-center font-semibold text-zinc-600 rounded-md p-2 hover:bg-zinc-200 cursor-pointer dark:hover:bg-zinc-700 dark:text-zinc-400">
          <FiList
            size="1.25rem"
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="font-semibold text-zinc-600 text-sm flex gap-4 items-center dark:text-zinc-400">
    ...
    <div className="flex flex-col gap-2">
      ...
      <p className="flex gap-4 items-center text-sm font-semibold text-zinc-600 rounded-md p-2 hover:bg-zinc-200 cursor-pointer dark:hover:bg-zinc-700 dark:text-zinc-400">
        <FiLogOut
          size="1.25rem"
          className="stroke-zinc-600 dark:stroke-zinc-400"
        />
