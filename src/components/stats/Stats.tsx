...
const Stats = (): JSX.Element => (
  <div className="w-full flex gap-4 flex-wrap">
    <div className="shadow-sm rounded flex-1 flex flex-col gap-6 border p-6 dark:border-gray-800 dark:bg-gray-800">
      <div className="flex items-center gap-4">
        ...
        <div className="font-semibold text-gray-500 dark:text-gray-200">
          Income
        </div>
      </div>
      <div className="flex gap-2 items-baseline">
        <div className="font-bold text-3xl dark:text-gray-100">1000</div>
        <span className="text-md text-gray-300 font-medium dark:text-gray-400">
          BAM
        </span>
      </div>
    ...
    <div className="shadow-sm rounded flex-1 flex flex-col gap-6 border p-6 dark:border-gray-800 dark:bg-gray-800">
      ...
      <div className="flex gap-2 items-baseline">
        <div className="font-bold text-3xl dark:text-gray-100">300</div>
        <span className="text-md text-gray-300 font-medium dark:text-gray-400">
          BAM
        </span>
      </div>
    ...
    <div className="shadow-sm rounded flex-1 flex flex-col gap-6 border p-6 dark:border-gray-800 dark:bg-gray-800">
      ...
      <div className="flex gap-2 items-baseline">
        <div className="font-bold text-3xl dark:text-gray-100">700</div>
        <span className="text-md text-gray-300 font-medium dark:text-gray-400">
          BAM
        </span>
      </div>
