...
const Alert = (): JSX.Element => (
  <div className="flex items-center flex-col gap-4 w-full">
    <div className="flex gap-4 shadow-sm rounded border text-emerald-600 border-emerald-400 bg-emerald-100 px-3 w-full max-w-md dark:text-emerald-300 dark:border-emerald-600 dark:bg-emerald-900/50">
    ...
    <div className="flex gap-4 shadow-sm rounded border text-cyan-600 border-cyan-400 bg-cyan-100 px-3 w-full max-w-md dark:text-cyan-300 dark:border-cyan-600 dark:bg-cyan-900/50">
    ...
    <div className="flex gap-4 shadow-sm rounded border text-amber-600 border-amber-400 bg-amber-100 px-3 w-full max-w-md  dark:text-amber-300 dark:border-amber-600 dark:bg-amber-900/50">
    ...
    <div className="flex gap-4 shadow-sm rounded border text-rose-600 border-rose-400 bg-rose-100 px-3 w-full max-w-md  dark:text-rose-300 dark:border-rose-600 dark:bg-rose-900/50">
